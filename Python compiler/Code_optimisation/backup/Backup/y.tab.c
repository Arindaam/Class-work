...
#line 1 "Parser.y"
	...
	void codegen_assign(){
  	...
  	void loop_condition(){
		...
		sprintf(tmp_i, "%d", temp_i);
		strcat(temp,tmp_i);
		printf("%s = not %s",temp,st[stack_t]);
  	...
  	void endblock(){
  		...
  		int gotos;
  		if(ltop==-1){
  			printf("goto L%d",label_n);
  			gotos=label_n++;
  		}
  		else{
  			gotos=labels[ltop--];
  			printf("goto L%d",gotos);
  		}
  		labels[++ltop]=gotos;	
  	}
...
{
       0,   227,   227,   227,   229,   239,   242,   276,   278,   278,
     278,   284,   284,   286,   286,   286,   286,   286,   288,   288,
     300,   302,   302,   302,   306,   306,   306,   306,   306,   306,
     308,   308,   308,   308,   308,   308,   308,   310,   312,   318,
     332,   318,   334,   334,   336,   338,   338,   338,   342,   342,
     344,   344,   344,   346,   346,   348,   348,   348,   348,   350,
     350,   350,   350,   350,   350,   350,   350,   352,   352,   354,
     354,   354,   356,   356,   356,   364,   364,   364,   366,   366,
     368,   368,   368,   376,   376,   376,   379,   381,   381,   385,
     381,   387,   396,   387
};
#endif
...
#line 364 "Parser.y"
                                                                                                        {printf("Goto L%d",pops);printf("L%d:",label_n-1);}
#line 2016 "y.tab.c"
    break;
